...
| Water Tracking | Daily hydration log + goal + personal cup/bottle presets, plus a graduated goal-completion / over-goal banner (celebration at 100%, calm amber/rose over-goal states, non-medical wording) | `components/water/*`, `lib/water-status.ts`, `docs/WATER_TRACKING.md`, `docs/WATER_PRESETS.md`, `docs/WATER_GOAL_UX_UPGRADE.md` |
