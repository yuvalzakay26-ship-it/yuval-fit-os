...
>
> Last reviewed: Phase 3.25 (codebase optimization & documentation cleanup).
...
| Water Tracking | Daily hydration log + goal | `components/water/*`, `docs/WATER_TRACKING.md` |
...
| `yfos:settings` | App settings **including the theme** (`settings.theme`) | Settings / Theme |
...
- **Settings** — `Settings` (theme, goals, water goal, protein calc inputs).
